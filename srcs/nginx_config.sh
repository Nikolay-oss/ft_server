...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/private/nginx_server.key -out /etc/ssl/certs/nginx_server.crt -subj "/C=RU/ST=Moscow/L=Moscow/O=21school/CN=dkenchur"
